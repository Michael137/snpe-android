...
public class ClassifyImageWithFloatTensorTask extends AbstractClassifyImageTask {
    ...
    protected String[] doInBackground(Bitmap... params) {
        final long preprocStart = SystemClock.elapsedRealtime();
        ...
        final long preprocEnd = SystemClock.elapsedRealtime();
        mPreprocTime = preprocEnd - preprocStart;
        ...
        final long postprocStart = SystemClock.elapsedRealtime();
        ...
        final long postprocEnd = SystemClock.elapsedRealtime();
        mPostProcTime = postprocEnd - postprocStart;
