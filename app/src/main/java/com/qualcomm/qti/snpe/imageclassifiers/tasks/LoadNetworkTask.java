...
public class LoadNetworkTask extends AsyncTask<File, Void, NeuralNetwork> {
    ...
    private static final String LOG_DEBUG = LoadNetworkTask.class.getSimpleName() + "_debug";
    private static final String LOG_TIME = LoadNetworkTask.class.getSimpleName() + "_time";
